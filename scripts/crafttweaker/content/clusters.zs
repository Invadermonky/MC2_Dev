...
mods.jei.JEI.addDescription([<contenttweaker:cluster_aluminum>,<contenttweaker:cluster_cinnabar>,<contenttweaker:cluster_copper>,<contenttweaker:cluster_gold>,<contenttweaker:cluster_iron>,<contenttweaker:cluster_lead>,<contenttweaker:cluster_nickel>,<contenttweaker:cluster_platinum>,<contenttweaker:cluster_silver>,<contenttweaker:cluster_tin>,<contenttweaker:cluster_uranium>],"A cluster of rough-hewn ore. Functionally the same as a block of ore, except it's an item. Neat!");
