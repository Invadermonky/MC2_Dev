...
mods.chisel.Carving.addVariation("amethyst_block", <biomesoplenty:gem_block>);
...
# CLAY TILES
recipes.removeByRecipeName("cathedral:roof_block_natural");
recipes.removeByRecipeName("cathedral:claytile");

mods.chisel.Carving.addVariation("hardenedclay", <cathedral:roofing_block_natural>);
mods.chisel.Carving.addVariation("hardenedclaydyed_black", <cathedral:roofing_block_black>);
mods.chisel.Carving.addVariation("hardenedclaydyed_blue", <cathedral:roofing_block_blue>);
mods.chisel.Carving.addVariation("hardenedclaydyed_brown", <cathedral:roofing_block_brown>);
mods.chisel.Carving.addVariation("hardenedclaydyed_cyan", <cathedral:roofing_block_cyan>);
mods.chisel.Carving.addVariation("hardenedclaydyed_gray", <cathedral:roofing_block_gray>);
mods.chisel.Carving.addVariation("hardenedclaydyed_green", <cathedral:roofing_block_green>);
mods.chisel.Carving.addVariation("hardenedclaydyed_light_blue", <cathedral:roofing_block_light_blue>);
mods.chisel.Carving.addVariation("hardenedclaydyed_lime", <cathedral:roofing_block_lime>);
mods.chisel.Carving.addVariation("hardenedclaydyed_magenta", <cathedral:roofing_block_magenta>);
mods.chisel.Carving.addVariation("hardenedclaydyed_orange", <cathedral:roofing_block_orange>);
mods.chisel.Carving.addVariation("hardenedclaydyed_pink", <cathedral:roofing_block_pink>);
mods.chisel.Carving.addVariation("hardenedclaydyed_purple", <cathedral:roofing_block_purple>);
mods.chisel.Carving.addVariation("hardenedclaydyed_red", <cathedral:roofing_block_red>);
mods.chisel.Carving.addVariation("hardenedclaydyed_silver", <cathedral:roofing_block_silver>);
mods.chisel.Carving.addVariation("hardenedclaydyed_white", <cathedral:roofing_block_white>);
mods.chisel.Carving.addVariation("hardenedclaydyed_yellow", <cathedral:roofing_block_yellow>);