...
# engineering
goodies.addItemEntryHelper(<enderio:item_basic_capacitor:4>, 30, 0, [Functions.parse({"function": "enderio:set_capacitor"})], [Conditions.parse({"condition": "required_stage","stage_name": "Dark_Engineering"})]);
...
treasure.addItemEntry(<ebwizardry:arcane_tome:2>, 8, 0);
...
treasure.addItemEntryHelper(<minecraft:enchanted_book:0>.withTag({StoredEnchantments: [{lvl: 1, id: 70}]}), 5, 0, [], []); # MENDING
...
treasure.addItemEntryHelper(<minecraft:elytra>, 15, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:1>, 10, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
...
# complete mastery
treasure.addItemEntryHelper(<spectrite:spectrite_gem>, 50, 0, [Functions.setCount(2, 3)], [Conditions.parse({"condition": "required_stage","stage_name": "complete_mastery"})]);
treasure.addItemEntryHelper(<spectrite:spectrite_star>, 25, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "complete_mastery"})]);