...
val table = loottweaker.LootTweaker.getTable("minecraft:chests/woodland_mansion");
...
filler.addItemEntryHelper(<minecraft:book>, 12, 0, [Functions.setCount(2, 4)], []);
filler.addItemEntryHelper(<minecraft:paper>, 15, 0, [Functions.setCount(2, 4)], []);
