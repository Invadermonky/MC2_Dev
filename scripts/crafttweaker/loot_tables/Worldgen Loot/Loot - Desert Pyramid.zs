...
treasure.addLootTableEntry("ebwizardry:subsets/wand_upgrades", 32, 0);
...
treasure.addItemEntryHelper(<everlastingabilities:ability_totem>, 32, 0, [Functions.parse({"function": "everlastingabilities:set_random_ability"})], []);
treasure.addItemEntry(<qualitytools:emerald_ring>, 25, 0);
...
treasure.addItemEntry(<minecraft:gold_block>, 24, 0);
...
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:2>, 2, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
