...
val table = loottweaker.LootTweaker.getTable("minecraft:chests/simple_dungeon");
...
goodies.addItemEntryHelper(<mysticalmechanics:gear_iron>, 15, 0, [Functions.setCount(2, 3)], []);
goodies.addItemEntryHelper(<mysticalmechanics:gear_gold>, 7, 0, [Functions.setCount(2, 3)], []);
...
goodies.addItemEntryHelper(<ebwizardry:ruined_spell_book>, 4, 0, [], []);
...
goodies.addItemEntryHelper(<enderio:item_basic_capacitor:4>, 15, 0, [Functions.parse({"function": "enderio:set_capacitor"})], [Conditions.parse({"condition": "required_stage","stage_name": "Dark_Engineering"})]);
...
# any class
treasure.addLootTableEntry("ebwizardry:subsets/wand_upgrades", 30, 0);
treasure.addLootTableEntry("ebwizardry:subsets/arcane_tomes", 20, 0);
treasure.addItemEntry(<ebwizardry:ethereal_crystalweave>, 4, 0);
treasure.addItemEntry(<ebwizardry:crystal_silver_plating>, 4, 0);
treasure.addItemEntry(<ebwizardry:resplendent_thread>, 4, 0);
treasure.addItemEntryHelper(<everlastingabilities:ability_totem>, 25, 0, [Functions.parse({"function": "everlastingabilities:set_random_ability"})], []);
...
treasure.addItemEntry(<minecraft:diamond>, 45, 0);
...
treasure.addItemEntry(<contenttweaker:lifeblood_crystal>, 35, 0);
...
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:7>, 1, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:2>, 1, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:5>, 1, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:3>, 1, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
treasure.addItemEntryHelper(<dragonmounts:dragon_egg:4>, 1, 0, [], [Conditions.parse({"condition": "required_stage","stage_name": "Adventuring"})]);
