...
val table = loottweaker.LootTweaker.getTable("ebwizardry:chests/shrine");
...
goodies.addItemEntry(<ebwizardry:grand_crystal>, 12, 0);
...
# any class
treasure.addLootTableEntry("ebwizardry:subsets/wand_upgrades", 60, 0);
treasure.addLootTableEntry("ebwizardry:subsets/arcane_tomes", 40, 0);
treasure.addItemEntry(<ebwizardry:ethereal_crystalweave>, 5, 0);
treasure.addItemEntry(<ebwizardry:crystal_silver_plating>, 5, 0);
treasure.addItemEntry(<ebwizardry:resplendent_thread>, 5, 0);
treasure.addItemEntry(<ebwizardry:astral_diamond>, 12, 0);
treasure.addItemEntryHelper(<ebwizardry:grand_crystal>, 20, 0, [Functions.setCount(2, 3)], []);
