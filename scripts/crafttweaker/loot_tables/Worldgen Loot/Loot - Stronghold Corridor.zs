...
val table = loottweaker.LootTweaker.getTable("minecraft:chests/stronghold_corridor");
...
goodies.addItemEntryHelper(<mysticalmechanics:gear_iron>, 12, 0, [Functions.setCount(2, 3)], []);
goodies.addItemEntryHelper(<mysticalmechanics:gear_gold>, 6, 0, [Functions.setCount(2, 3)], []);
