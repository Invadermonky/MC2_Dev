...
function initItemsAndRecipesStaging() {
	...
	scripts.crafttweaker.gamestages.items.mods.appliedenergistics2.init();
	...
	scripts.crafttweaker.gamestages.items.mods.engineersdecor.init();
	scripts.crafttweaker.gamestages.items.mods.grimoire.init();
	scripts.crafttweaker.gamestages.items.mods.harvestcraft.init();
	...
	scripts.crafttweaker.gamestages.items.mods.mystgears.init();
	scripts.crafttweaker.gamestages.items.mods.rustic.init();
	scripts.crafttweaker.gamestages.items.mods.xreliquary.init();
	scripts.crafttweaker.gamestages.items.mods.waterstrainer.init();
